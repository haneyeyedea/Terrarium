...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_addAtoIndex0_A, "emptyList_addAtoIndex0_A", LIST_A, STRING_A);
		...
		testThreeElementList(ABC_setIndex0ToD_DBC, "ABC_setIndex0ToD_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_setIndex2ToD_ABD, "ABC_setIndex2ToD_ABD", LIST_ABD, STRING_ABD);
		// Iterator tests
	...
	/**
	 * Scenario: empty list -> addToIndex0(A) -> [A]
	 * 
	 * @return [A] after addToIndex0(A)
	 */
	private IndexedUnsortedList<Integer> emptyList_addAtoIndex0_A() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(0, ELEMENT_A);
		return list;
	}

	private Scenario<Integer> emptyList_addAtoIndex0_A = () -> emptyList_addAtoIndex0_A();
	 ...
	 */
	private IndexedUnsortedList<Integer> A_setIndex0ToB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.set(0, ELEMENT_B);
		return list;
	}

	private Scenario<Integer> A_setIndex0ToB_B = () -> A_setIndex0ToB_B();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_addCToIndex0_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.add(0, ELEMENT_C);
		return list;
	}

	private Scenario<Integer> AB_addCToIndex0_CAB = () -> AB_addCToIndex0_CAB();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_addCToIndex1_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.add(1, ELEMENT_C);
		return list;
	}

	private Scenario<Integer> AB_addCToIndex1_ACB = () -> AB_addCToIndex1_ACB();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_setIndex0ToD_DBC() {
		IndexedUnsortedList<Integer> list = AB_addAfterB_ABC();
		list.set(0, ELEMENT_D);
		return list;
	}

	private Scenario<Integer> ABC_setIndex0ToD_DBC = () -> ABC_setIndex0ToD_DBC();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_setIndex2ToD_ABD() {
		IndexedUnsortedList<Integer> list = AB_addAfterB_ABC();
		list.set(2, ELEMENT_D);
		return list;
	}

	private Scenario<Integer> ABC_setIndex2ToD_ABD = () -> ABC_setIndex2ToD_ABD();
	 ...
	 * 
	 * @return [A] after AB_IterRemoveA_A
	 */
	...
	/**
	 * Scenario: [A, B, C] -> IterRemoveA -> [B, C]
	 * 
	...
	/**
	 * Scenario: [A, B, C] -> IterRemoveB -> [A, C]
	 * 
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_iterNextRemove2_testIterHasNext",
					testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.False));
			printTest(scenarioName + "_iterNextRemove2_testIterNext",
					testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemove2_testIterRemove",
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIterNextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousRemoveRemove", testIterRemove(
						...
						Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousRemoveRemove", testIterRemove(
						listIterAfterRemove(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2)),
						Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousSet",
						testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousSet",
						testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2),
								ELEMENT_X, Result.NoException));
				...
				printTest(scenarioName + "_testListIter0NextNextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(0), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextPreviousPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 2),
								ELEMENT_X, Result.NoException));
				...
				printTest(scenarioName + "_testListIter1Set",
						testListIterSet(scenario.build().listIterator(1), ELEMENT_X, Result.IllegalState));
				printTest(scenarioName + "_testListIter1NextRemove",
						testIterRemove(listIterAfterNext(scenario.build().listIterator(1), 1), Result.NoException));
				...
				printTest(scenarioName + "_testListIter1NextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(1), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 1), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter1NextPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 1), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 1), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1PreviousRemove",
				...
				printTest(scenarioName + "_testListIter2PreviousNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 1), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(scenario.build().listIterator(2), 2), Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousAdd", testListIterAdd(
						listIterAfterPrevious(scenario.build().listIterator(2), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousSet", testListIterSet(
						listIterAfterPrevious(scenario.build().listIterator(2), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextAdd",
						testListIterAdd(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextAdd",
						testListIterAdd(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2),
								ELEMENT_X, Result.NoException));
			} else {
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_iterNextRemove2_testIterNext", testIterNext(
			...
			printTest(scenarioName + "_iterNextRemove3_testIterHasNext",
					testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), Result.False));
			printTest(scenarioName + "_iterNextRemove3_testIterNext",
					testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemove3_testIterRemove",
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIterNextNextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3),
								Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousRemoveRemove", testIterRemove(
						...
						Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousRemoveRemove", testIterRemove(
						listIterAfterRemove(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2)),
						Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousRemoveRemove",
						testIterRemove(
								listIterAfterRemove(listIterAfterPrevious(
										listIterAfterNext(scenario.build().listIterator(), 3), 3)),
								Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousAdd",
						testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousSet",
						testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousSet",
						testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousSet",
						testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3),
								ELEMENT_X, Result.NoException));
				...
				printTest(scenarioName + "_testListIter0NextNextPreviousPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextRemove",
						testIterRemove(listIterAfterNext(scenario.build().listIterator(0), 3), Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextAdd", testListIterAdd(
						listIterAfterNext(scenario.build().listIterator(0), 3), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(0), 3), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 3),
								Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousPreviousPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 3),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter0NextNextNextPreviousPreviousPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 3), 3),
								ELEMENT_X, Result.NoException));
				...
				printTest(scenarioName + "_testListIter1NextPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 1), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextRemove",
						testIterRemove(listIterAfterNext(scenario.build().listIterator(1), 2), Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextAdd", testListIterAdd(
						listIterAfterNext(scenario.build().listIterator(1), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(1), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 2), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 2), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextPreviousPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1NextNextPreviousPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(1), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter1PreviousRemove",
				...
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2NextRemove",
						testIterRemove(listIterAfterNext(scenario.build().listIterator(2), 1), Result.NoException));
				printTest(scenarioName + "_testListIter2NextAdd", testListIterAdd(
						listIterAfterNext(scenario.build().listIterator(2), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2NextSet", testListIterSet(
						listIterAfterNext(scenario.build().listIterator(2), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2NextPreviousRemove",
						testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(2), 1), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter2NextPreviousAdd",
						testListIterAdd(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(2), 1), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter2NextPreviousSet",
						testListIterSet(
								listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(2), 1), 1),
								ELEMENT_X, Result.NoException));
				...
				printTest(scenarioName + "_testListIter3PreviousNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 1), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(scenario.build().listIterator(3), 2), Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousAdd", testListIterAdd(
						listIterAfterPrevious(scenario.build().listIterator(3), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousSet", testListIterSet(
						listIterAfterPrevious(scenario.build().listIterator(3), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextAdd",
						testListIterAdd(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextNextAdd",
						testListIterAdd(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousRemove",
						testIterRemove(listIterAfterPrevious(scenario.build().listIterator(3), 3), Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousAdd", testListIterAdd(
						listIterAfterPrevious(scenario.build().listIterator(3), 3), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousSet", testListIterSet(
						listIterAfterPrevious(scenario.build().listIterator(3), 3), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 1),
								Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousNextNextRemove",
						testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 2),
								Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousNextAdd",
						testListIterAdd(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 1),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousNextNextAdd",
						testListIterAdd(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 2),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 3),
								ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousPreviousNextNextSet",
						testListIterSet(
								listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 3), 2),
								ELEMENT_X, Result.NoException));
			} else {
