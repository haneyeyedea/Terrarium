...
public class TrafficAnimation extends JPanel
{
	...
	private final Color TRUCK_SILVER = new Color(192,192,192);
	...
	public void paintComponent(Graphics g)
	{
		...
		g.setFont(new Font("Calisto MT", Font.BOLD, 3*width/50));
		g.drawString(str, 25*width/80, 9*height/80);
		...
		// Create Avatar
		int xOffAva = 4*width/5;
		int avaY = 33*height/100;
		int avaWidth = width/20;
		int avaHeight = height/6;
		
		g.setColor(Color.blue);
		g.fillRect(xOffAva+3*avaWidth/8, avaY+avaHeight/6, avaWidth/5, avaHeight/6);
		g.fillRect(xOffAva+avaWidth/4, avaY+5*avaHeight/8, avaWidth/6, 7*avaHeight/20);
		g.fillRect(xOffAva+5*avaWidth/8, avaY+5*avaHeight/8, avaWidth/6, 7*avaHeight/20);
		
		g.setColor(Color.red);
		g.fillOval(xOffAva+width/100, avaY+avaHeight/40, avaWidth/2, avaHeight/4);
		g.fillRect(xOffAva+avaWidth/6, avaY+3*avaHeight/10, 2*avaWidth/3, 4*avaHeight/10);

		g.setColor(Color.black);
		g.drawLine(xOffAva+avaWidth/6, avaY+3*avaHeight/10, xOffAva, avaY+5*avaHeight/10);
		g.drawLine(xOffAva, avaY+5*avaHeight/10, xOffAva+avaWidth/6, avaY+7*avaHeight/10);
		g.drawLine(xOffAva+5*avaWidth/6, avaY+3*avaHeight/10, xOffAva+avaWidth, avaY);
		g.fillArc(xOffAva+avaWidth/10, avaY+9*avaHeight/10, avaHeight/5, avaHeight/5, 0, 180);
		g.fillArc(xOffAva+4*avaWidth/8, avaY+9*avaHeight/10, avaHeight/5, avaHeight/5, 0, 180);
		g.drawOval(xOffAva+3*avaWidth/12, avaY+avaHeight/15, avaWidth/5, avaWidth/5);
		g.drawOval(xOffAva+6*avaWidth/12, avaY+avaHeight/15, avaWidth/5, avaWidth/5);
		...
		g.fillRect(xOff2-truckWidth/20, truckY-5*truckHeight/30, truckWidth, 2*truckHeight/10);
		g.fillRect(xOff2+5*truckWidth/8, truckY+truckHeight/20, truckWidth/6, 5*truckHeight/8);
		g.fillRect(xOff2+13*truckWidth/16, truckY+truckHeight/20, truckWidth/6, 5*truckHeight/8);
		
		g.setColor(Color.black);
		g.drawRect(xOff2-truckWidth/20, truckY-5*truckHeight/30, truckWidth, 2*truckHeight/10);
